...
export interface ApiBuyWithBuyWith extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    SourcePoolId: Schema.Attribute.BigInteger;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiContractsOnChainContractsOnChain
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    MultiCallV3: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'0xcA11bde05977b3631167028862bE2a173976CA11'>;
...
export interface ApiTradeContractTradeContract
  ...
  info: {
    displayName: 'TradeContract';
    pluralName: 'trade-contracts';
    singularName: 'trade-contract';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    AdressList: Schema.Attribute.Component<'tokenomics.list-of-strings', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::trade-contract.trade-contract'
    > &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String &
      Schema.Attribute.Required &
